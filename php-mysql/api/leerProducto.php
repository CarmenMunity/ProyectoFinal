...
$productos = [];
$sql = "SELECT p.Id, p.Nombre, p.Descripcion, p.Tipo, p.Ingredientes, p.Marca, c.Nombre as Cat  FROM producto p, categoria c WHERE p.Categoria = c.Id";
